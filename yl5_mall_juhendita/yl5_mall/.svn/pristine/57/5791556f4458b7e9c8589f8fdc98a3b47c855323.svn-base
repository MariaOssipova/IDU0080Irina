...
public class Kuller_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/BPTeenused/services/kullerSOAP?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Kuller_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8086/kuller?wsdl");
        }
        WSDL_LOCATION = url;
    }
